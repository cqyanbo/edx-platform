 ...
 */
define([
    'js/views/baseview', 'js/certificates/views/signatory_editor', 'underscore', "js/utils/templates", 'gettext', 'underscore.string'
],
function(BaseView, SignatoryEditorView, _, TemplateUtils, gettext, str) {
    'use strict';
